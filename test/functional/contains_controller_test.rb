...
class ContainsControllerTest < ActionController::TestCase
  ...
  test "should create contain" do
    assert_difference('Contain.count') do
      post :create, contain: { assignment_id: @contain.assignment_id, course_id: @contain.course_id, question: @contain.question }
    end
  ...
  test "should update contain" do
    put :update, id: @contain, contain: { assignment_id: @contain.assignment_id, course_id: @contain.course_id, question: @contain.question }
    assert_redirected_to contain_path(assigns(:contain))
  end
